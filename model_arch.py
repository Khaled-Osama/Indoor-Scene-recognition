    ...
    with tf.variable_scope(scope, 'InceptionResnetV2', [inputs]):
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            net = slim.repeat(net, 10, block35, scale=0.17,
                              activation_fn=activation_fn)  # 10
            ...
            with slim.arg_scope([slim.conv2d], rate=2 if use_atrous else 1):
                net = slim.repeat(net, 15, block17, scale=0.10,
                                  activation_fn=activation_fn)  # 20
            ...
            # TODO(alemi): register intermediate endpoints
            net = slim.repeat(net, 5, block8, scale=0.20, activation_fn=activation_fn)  # 9
...
def inception_resnet_v2(inputs, num_classes=1001, is_training=True, drop_out_training=True,
    ...
    with tf.variable_scope(scope, 'InceptionResnetV2', [inputs],
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf.variable_scope('Logits'):
                ...
                net = slim.dropout(net, dropout_keep_prob, is_training=drop_out_training,
                                   scope='Dropout')
